        ...
        public void ConsultarDatos()
        {
            using (SqlConnection conexion = variable_Conexion.Conectar())
            {
                try
                {
                    ...
                    tabla_prodTemp.Columns[0].Width = 100;
                    tabla_prodTemp.Columns["Producto"].Width = 200;
                    tabla_prodTemp.Columns["Temporada"].Width = 250;
                    ...
                    //tabla_prodTemp.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
